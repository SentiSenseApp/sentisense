...
| `get_analyst_called_it(ticker, limit=None)` | Recorded call history for moves of 20% or more over five sessions. Free: newest move, up to 5 calls, move counts intact |
